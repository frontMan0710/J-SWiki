$(function () {
    if($(window).width() > 1920) {
        ...
        $(".sectionTitle, .buttonWrapper").css({"height":"144px"})
        $("h3, p, span, li, input, a, button").css({"font-size":"20px"})
        ...
        $(".sectionTitle, .buttonWrapper").css({"max-height":"144px", "height":"7.5vw"})
        $("h3, p, span, li, input, a, button").css({"font-size":"1.04vw"})
        ...
        $(".sectionTitle, .buttonWrapper").css({"max-height":"144px", "height":"14.07vw"})
        $("h3, p, span, li, input, a, button").css({"font-size":"1.95vw"})
        ...
        $(".sectionTitle, .buttonWrapper").css({"max-height":"144px", "height":"18.77vw"})
        $("h3, p, span, li, input, a, button").css({"font-size":"2.6vw"})
        ...
        $(".sectionTitle, .buttonWrapper").css({"max-height":"144px", "height":"33.96vw"})
        $("h3, p, span, li, input, a, button").css({"font-size":"4.71vw"})
